 ...
 * contents of LexAlias.xs. Do not edit this file, edit LexAlias.xs instead.
 *
...
XS_EUPXS(XS_Devel__LexAlias__lexalias); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Devel__LexAlias__lexalias)
{
    dVAR; dXSARGS;
    if (items != 3)
       croak_xs_usage(cv,  "cv_ref, name, new_rv");
    {
	SV*	cv_ref = ST(0)
;
...
extern "C"
#endif
XS_EXTERNAL(boot_Devel__LexAlias); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Devel__LexAlias)
{
    dVAR; dXSARGS;
    ...
    XS_VERSION_BOOTCHECK;
        ...
        newXS("Devel::LexAlias::_lexalias", XS_Devel__LexAlias__lexalias, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
