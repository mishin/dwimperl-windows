...
#line 162 "MethodMaker.c"

XS_EUPXS(XS_Class__MethodMaker_set_sub_name); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Class__MethodMaker_set_sub_name)
{
    dVAR; dXSARGS;
    if (items != 4)
...
extern "C"
#endif
XS_EXTERNAL(boot_Class__MethodMaker); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Class__MethodMaker)
{
    dVAR; dXSARGS;
